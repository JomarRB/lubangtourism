<?php
	...
	if(ISSET($_POST['add_guest'])){
		...
		$checkin = $_POST['date'];
		$conn->query("INSERT INTO `guest` (firstname, middlename, lastname, address, nationality, contactno) VALUES('$firstname', '$middlename', '$lastname', '$address', '$nationality', '$contactno')") or die(mysqli_error());
