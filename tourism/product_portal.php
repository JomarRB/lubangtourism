...
<section class="page-section bg-gray text-dark" id="product">
	<div class="container">
		<div class="text-center">
			<h2 class="section-heading text-uppercase text-info">Lubang Tourism Products</h2>
		</div>
		<div>
			<div class="card w-100">
				<div class="card-body">
					<?php echo file_get_contents(base_app.'product.html') ?>
				</div>
			</div>
		</div>
	</div>
