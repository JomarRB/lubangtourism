  ...
  <div class="container-fluid">
    ...
    <h1 class="d-inline-block align-text-top text-info" >LubangTourism</h1>
        ...
        <div class="position-relative text-bg-info p-4" style = "max-width: 100%;" >
          <h3 class="position-absolute top-0 start-50 translate-middle-x" >MICHELLE'S LODGING HOUSE</h3>
        </div>
				<?php
					require_once 'admin_michelles/connect.php';
          ...
          <div class="row g-0 p-3 " >
            ...
            <div class="col-md-8">
						<div class="card-body text-dark">
							...
							<a style = "margin-left:580px;" href = "add_reserve-michelles.php?room_id=<?php echo $fetch['room_id']?>" class = "btn btn-info"><i class = "glyphicon glyphicon-list"></i> Reserve</a>
						</div>
					</div>
        </div>
        </div>
