          ...
          <div class="row g-0 p-3 " >
            ...
            <div class="col-md-8">
						<div class="card-body text-dark">
							...
							<a style = "margin-left:580px;" href = "add_reserve-lubangbh.php?room_id=<?php echo $fetch['room_id']?>" class = "btn btn-info"><i class = "glyphicon glyphicon-list"></i> Reserve</a>
						</div>
					</div>
        </div>
        </div>
